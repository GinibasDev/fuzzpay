...
export default function AdminWithdrawalReportPage() {
  ...
  const handleExport = () => {
    ...
    link.setAttribute("download", `admin_withdrawal_report_${new Date().toISOString().split('T')[0]}.csv`)
    ...
    <AdminLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Generate and export withdrawal reports</p>
        </div>

...
export default function AdminUSDTWalletPage() {
  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold mb-2">USDT Wallet</h1>
          <p className="text-muted-foreground">View and manage USDT wallet balance</p>
        </div>

...
export default function PayinReportPage() {
  ...
  const handleExport = () => {
    ...
    link.setAttribute("download", `payin_report_${new Date().toISOString().split('T')[0]}.csv`)
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">View and export payin transaction reports</p>
        </div>

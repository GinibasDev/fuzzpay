...
export default function PayoutReportPage() {
  ...
  const handleExport = () => {
    ...
    link.setAttribute("download", `payout_report_${new Date().toISOString().split('T')[0]}.csv`)
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">View and export payout transaction reports</p>
        </div>

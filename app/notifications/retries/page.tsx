...
export default function NotificationRetriesPage() {
  ...
  const retryLogs = [
    {
      ...
      callbackUrl: "https://merchant-b.com/callback",
      retryCount: "3",
      lastAttempt: "2024-01-12 11:00",
      nextRetry: "2024-01-12 11:30",
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold mb-2">Notification Retry Logs</h1>
            <p className="text-muted-foreground">Track callback retry attempts</p>
          </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b">
                      ...
                      <th className="text-left p-2 font-medium">Next Retry</th>
                  ...
                  <tbody>
                    {retryLogs.map((log) => (
                      <tr key={log.id} className="border-b last:border-0">
                        ...
                        <td className="p-2 font-medium">{log.retryCount}</td>
                        <td className="p-2 text-sm">{log.lastAttempt}</td>
                        <td className="p-2 text-sm">{log.nextRetry}</td>
                        <td className="p-2">

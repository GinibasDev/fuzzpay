...
export default function PayinPendingPage() {
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold mb-2">Payin Pending List</h1>
            <p className="text-muted-foreground">View and manage pending payin transactions</p>
          </div>

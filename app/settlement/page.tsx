    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Track all settlement transactions</p>
        </div>
                  ...
                  <tbody>
                    {settlements.map((settlement) => (
                      <tr key={settlement.id} className="border-b last:border-0 hover:bg-muted/50">
                        ...
                        <td className="p-3 whitespace-nowrap">{settlement.merchant}</td>
                        <td className="p-3 whitespace-nowrap">{settlement.orderNumber}</td>
                        <td className="p-3 whitespace-nowrap">{settlement.date}</td>
                        <td className="p-3 whitespace-nowrap font-medium">{settlement.amountReceived}</td>
                        <td className="p-3 whitespace-nowrap font-medium">{settlement.settlementAmount}</td>
                        <td className="p-3 whitespace-nowrap font-medium text-green-600">{settlement.settledAmount}</td>
                        <td className="p-3 whitespace-nowrap font-medium text-yellow-600">

...
export default function WalletINRPage() {
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold mb-2">Admin INR Wallet</h1>
            <p className="text-muted-foreground">Manage your INR wallet balance</p>
          </div>
